...
meineApp.post('/about',(browserAnfrage, serverAntwort, next) => {              
...
meineApp.post('/kontoAnlegen',(browserAnfrage, serverAntwort, next) => {              
    ...
    dbVerbindung.query('INSERT INTO konto(iban, idKunde, anfangssaldo, kontoart, timestamp) VALUES ("' + ibahn + '", 150000, 1, "' + kontoArt + '", NOW()) ;', function (fehler) {
...
meineApp.get('/Überweisen',(browserAnfrage, serverAntwort, next) => {              
